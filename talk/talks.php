<?php
	...
	while($row = mysql_fetch_array($result))
		{
			...
			switch ($status)
				{
					...
					case 0:    
						...
						if (!$apply) {
							$check='<div style="color:blue"><a href="check.php?id='.$id.'&type=1" class="buttonlink acc">Accept</a><a href="check.php?id='.$id.'&type=0" class="buttonlink rej">Reject</a></div>';
						}
						break; 
					case 1:    
			...
			$txt=$txt.'<td><div class="name">'.getname($with).'</div></td>';
	...
	$html='<table id="talks" class="box-table"><tr><th>With</th><th>Description</th><th>Time</th><th>Location</th><th>Status</th></tr>'.$html."</table>";
	echo $html;
?>